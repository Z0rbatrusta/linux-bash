#!/bin/bash 1- Como aprender a programar en bash los diferentes colores y fondos por pantalla. ID 3455468768964535667
  # 
  # Este fichero saca por pantalla un montón de códigos de color
  # para demostrar qué hay disponible. Cada línea es un color con
  # fondo negro y gris, con el código en medio. Funciona sobre
  # fondos blancos, negros y verdes
  #
  ...
  echo -e "\033[47m\033[31m  Rojo          \033[0m\
     31m \#!/bin/bash Como aprender a programar en bash los diferentes col
